...
namespace DVLD.People
{
    public partial class frmAddUpdatePerson : Form
    {
        ...
        private void _LoadData()
        {
            ...
            if (_Person.CarImagePath != "")
            {
                pbCarImage.ImageLocation = _Person.CarImagePath;
            ...
            llRemoveImage.Visible = (_Person.CarImagePath != "");
        ...
        private bool _HandleCarImage()
        {
            ...
            //_Person.ImagePath contains the old Image, we check if it changed then we copy the new image
            if (_Person.CarImagePath != pbCarImage.ImageLocation)
            {
                if (_Person.CarImagePath != "")
                {
                    //first we delete the old image from the folder in case there is any.
                    ...
                    try
                    {
                        File.Delete(_Person.CarImagePath);
                    }
                    catch (IOException)
                    {
                        // We could not delete the file.
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
           ...
           if (! _HandlePersonImage())
            ...
            if (pbCarImage.ImageLocation != null)
                _Person.CarImagePath = pbCarImage.ImageLocation;
            else
                _Person.CarImagePath = "";
        ...
        {
            openFileDialog2.Filter = "Image Files|*.jpg;*.jpeg;*.png;*.gif;*.bmp";
